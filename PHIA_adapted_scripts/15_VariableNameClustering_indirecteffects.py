...
##### Execution ############################################
############################################################
os.chdir(r"C:\Users\4209416\OneDrive - Universiteit Utrecht\Desktop\ETAIN\PHIA_framework\Automated-KG\newCrossRef\Indirect_Effects\Indirect_effects")
filename = "unique_evidence_instances_true_clean_EC_unique_SG_unique_IE_unique"
...
##################################################################################################
variable_type = "DirectEffects"
TypeAbbrev = "DE"

#variable_type = "IndirectEffects"
#TypeAbbrev = "IE"

#variable_type = "StudyGroup"
#TypeAbbrev = "SG"

#variable_type = "EcoConsequences"
#TypeAbbrev = "EC"

evidence_instances_full[variable_type] = [el.lower() for el in evidence_instances_full[variable_type]]

if mode == "manualCheck":
    if variable_type == "IndirectEffects": #"StudyGroup"
    ...
    if variable_type == "DirectEffects":
